...
///import { DialogOverviewExample } from '../e-commerce/tabs/TabsetShowcaseComponent.component';


import { ModalComponent } from './tabs/modal.component';
...
@NgModule({
  imports: [
    ...
    MatIconModule, MatButtonModule, MatSelectModule, MatInputModule, MatCheckboxModule, MatSidenavModule, MatListModule, MatFormFieldModule,
    FormsModule,
    NgxChartsModule,
    LeafletModule,
